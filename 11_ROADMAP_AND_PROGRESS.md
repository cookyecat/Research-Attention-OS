...
Current repository HEAD after hand-off documentation is `f2050194676422fa5f61ea49ced3e20039cb0cde`; the last functional code change is `b4175dd`. The next product-facing work should come from actual dogfood residuals, with a likely near-term cleanup being separation of historical dev/experiment Sources from live dogfood Attention views rather than deleting provenance.
