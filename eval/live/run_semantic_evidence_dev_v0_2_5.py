"""Run Semantic Evidence Extractor v0.2.5 minimal-sufficient candidate.
...
from eval.live.semantic_evidence_extractor_v0_2_5 import (
    build_messages,
    estimate_semantic_evidence_v0_2_5,
    invocation_record,
    prompt_sha256,
)

DEFAULT_OUT_DIR = ROOT / "eval" / "live" / "results" / "semantic_evidence_dev_v0_2_5"
...
def main() -> None:
    ...
    rows = []
    for source in sources:
        result = estimate_semantic_evidence_v0_2_5(source, as_of=args.as_of)
    ...
    artifact = {
        "name": "raos-semantic-evidence-development-run-v0.2.5-evidence-complete-cohesion",
    ...
    out_path = args.out_dir / f"semantic_evidence_dev_v0_2_5_{timestamp}.json"
    if out_path.exists():
