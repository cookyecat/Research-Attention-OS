...
from app.services.event_state_slot_delta import (
    ...
    apply_slot_delta,
    decide_slot_delta_with_audit,
    make_slot_state,
)

RUN_VERSION = "phase17-state-slot-delta-real-model-v0.2"
OUT_DIR = ROOT / "eval/live/results/phase17_state_slot_delta_real_model_v0_2"
def _db():
...
def _run_case(
    *,
    ...
    try:
        ...
        decision=decide_slot_delta_with_audit(
        ...
        return {
            ...
            "evidence_projection": [
                ...
                for row in decision.evidence_projection
            ],
