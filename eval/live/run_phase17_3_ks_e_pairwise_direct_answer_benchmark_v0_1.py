"""Phase17.3-KS-E live pairwise Direct-Answer benchmark v0.1."""
...
EXPLORATORY_CASES = [
    (6, "P002", "S009", None, "task completion time vs operational performance"),
...
def main():
    ...
    result = {
        "benchmark": "phase17.3-ks-e-pairwise-direct-answer-v0.1",
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_e_pairwise_direct_answer_v0_1"
        / "phase17_3_ks_e_pairwise_direct_answer_v0_1.json"
    )
