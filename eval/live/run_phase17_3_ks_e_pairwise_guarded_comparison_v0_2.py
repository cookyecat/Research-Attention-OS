...
def main():
    ...
    result = {
        "benchmark": "phase17.3-ks-e-pairwise-guarded-comparison-v0.2",
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_e_pairwise_guarded_comparison_v0_2"
        / "phase17_3_ks_e_pairwise_guarded_comparison_v0_2.json"
    )
