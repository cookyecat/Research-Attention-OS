...
def run_pairwise(previous, observation, flatmap):
    return with_retries(lambda: semantic_keyby_pairwise_guarded(
        ...
        candidate_top_k=2,
        pairwise_repeats=2,
        pairwise_transport="PROPOSITION_BATCH",
    ))
...
def main():
    ...
    for index, step in enumerate(trajectory):
        ...
        row = {
            **base,
            ...
            "authorized_existing_slot_count": sum(
                len(slot_ids)
                for slot_ids in guarded_result.address_policy
                .authorized_existing_slot_ids_by_proposition.values()
            ),
    ...
    result = {
        "benchmark": "phase17.3-ks-e-pairwise-guarded-comparison-v0.5",
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_e_pairwise_guarded_comparison_v0_5"
        / "phase17_3_ks_e_pairwise_guarded_comparison_v0_5.json"
    )
