"""Run Semantic Evidence Extractor v0.2.2 on selected development sources.

Development-only. Controlled audit-discipline revision over v0.2.1.
...
DEFAULT_OUT_DIR = ROOT / "eval" / "live" / "results" / "semantic_evidence_dev_v0_2_2"
...
def main() -> None:
    ...
    rows = []
    for source in sources:
        result = estimate_semantic_evidence_v0_2_2(source, as_of=args.as_of)
    ...
    out_path = args.out_dir / f"semantic_evidence_dev_v0_2_2_{timestamp}.json"
    if out_path.exists():
