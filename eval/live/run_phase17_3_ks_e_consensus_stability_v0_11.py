"""Phase17.3-KS-E two-judgment consensus stability stress v0.11.

Runs the frozen 16 strict Direct-Answer cases for multiple independent rounds
with repeats=2. Each pair still uses the original single-pair prompt; only
...
def main():
    ...
    result = {
        "benchmark": "phase17.3-ks-e-consensus-stability-v0.11",
        "round_count": ROUNDS,
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_e_consensus_stability_v0_11"
        / "phase17_3_ks_e_consensus_stability_v0_11.json"
    )
