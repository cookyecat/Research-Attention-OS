...
def main():
    ...
    result = {
        "benchmark": "phase17.3-ks-e-address-locked-comparison-v0.5",
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_e_address_locked_comparison_v0_5"
        / "phase17_3_ks_e_address_locked_comparison_v0_5.json"
    )
