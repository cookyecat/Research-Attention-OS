"""Phase17.3-KS-E live pairwise Direct-Answer benchmark v0.8."""
...
STRICT_CASES = [
    ...
    (5, "P002", "S006", "DIRECT", "prompt-controllable demo behavior -> demonstrated behaviors"),
...
EXPLORATORY_CASES = [
    (6, "P002", "S009", None, "task completion duration vs operational performance boundary"),
...
def main():
    ...
    result = {
        "benchmark": "phase17.3-ks-e-pairwise-direct-answer-v0.8",
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_e_pairwise_direct_answer_v0_8"
        / "phase17_3_ks_e_pairwise_direct_answer_v0_8.json"
    )
