"""Phase17.3-KS-E live pairwise Direct-Answer benchmark v0.3."""
...
def main():
    ...
    result = {
        "benchmark": "phase17.3-ks-e-pairwise-direct-answer-v0.3",
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_e_pairwise_direct_answer_v0_3"
        / "phase17_3_ks_e_pairwise_direct_answer_v0_3.json"
    )
