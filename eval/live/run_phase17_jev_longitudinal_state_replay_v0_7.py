...
RUN_VERSION = "phase17-jev-longitudinal-state-replay-v0.7"
...
OUT_DIR = ROOT / "eval/live/results/phase17_jev_longitudinal_state_replay_v0_7"
DEFAULT_CHECKPOINT = OUT_DIR / "phase17_jev_longitudinal_state_replay_v0.7_checkpoint.json"
            ...
            trajectory.append(
                {
                    ...
                    "proposition_flatmap": flatmap_audit,
                    "semantic_keyby": keyby_audit,
                    "delta_rationale": (
