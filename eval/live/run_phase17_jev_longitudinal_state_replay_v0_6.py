...
RUN_VERSION = "phase17-jev-longitudinal-state-replay-v0.6"
...
OUT_DIR = ROOT / "eval/live/results/phase17_jev_longitudinal_state_replay_v0_6"
DEFAULT_CHECKPOINT = OUT_DIR / "phase17_jev_longitudinal_state_replay_v0.6_checkpoint.json"
...
def _checkpoint_identity(
    *,
    ...
    return {
        ...
        "decider_contract": SLOT_DECIDER_CONTRACT,
    ...
    try:
        ...
        for ordinal, row in enumerate(
            ...
            if not new_units:
                ...
                evidence_projection = decision.evidence_projection
        ...
        return {
            ...
            "guardrails": [
                ...
                "Configured real LLM is used only for new CurrentSlot Decide calls; Slot Apply is deterministic.",
                ...
                "Checkpoint resume is rejected if projection digest or Decide/SlotDelta/SlotState/Apply contract identity changes.",
