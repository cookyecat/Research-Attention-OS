"""Phase17.3-KS-D Jev EXISTING-route retrieval benchmark v0.1.
...
def main():
    ...
    for step_index, step in enumerate(trajectory):
        ...
        propositions = (step.get("flatmap") or {}).get("world_propositions") or []
        draft = step.get("keyby_draft") or {}
    ...
    result = {
        "benchmark": "phase17.3-ks-d-jev-existing-route-retrieval-v0.1",
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_d_jev_existing_route_retrieval_v0_1"
        / "phase17_3_ks_d_jev_existing_route_retrieval_v0_1.json"
    )
