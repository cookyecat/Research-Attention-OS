...
def main():
    ...
    result = {
        "benchmark": "phase17.3-ks-e-pairwise-direct-answer-v0.2",
    ...
    output = (
        ROOT
        / "eval/live/results/phase17_3_ks_e_pairwise_direct_answer_v0_2"
        / "phase17_3_ks_e_pairwise_direct_answer_v0_2.json"
    )
