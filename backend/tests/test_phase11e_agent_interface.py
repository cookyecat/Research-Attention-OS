...
def test_capabilities_declares_single_attention_authority(client):
    ...
    assert body["version"] == "agent-interface-v0.4"
    ...
    assert contract["attention_candidate_contract"] == "event-centric-v0.1"
    assert contract["representative_reading_path"] == "analysis-run-primary-source"
